...
local UI = v0:CreateWindow({
    Title = "YOU HUB x SADHAX HUB v0.9.3.1.2(ALPHA)",
    Center = true,
    AutoShow = true,
    TabPadding = 10,
    MenuFadeTime = 0.1
