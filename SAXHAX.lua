...
OMG1:AddSlider("MySlider",{Text="WalkSpeed",Min=16,Default=16,Max=21,Rounding=1,Compact=true,Callback=function(Value)Speed = Value end})
OMG1:AddSlider("MySlider",{Text="Field Of View",Min=70,Default=70,Max=120,Rounding=1,Compact=true,Callback=function(Value)FOV = Value end})
