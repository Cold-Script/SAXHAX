...
local function selection(child, name, name2, name3)
	...
	if child:IsA("Part") then
		child.Color = Color3.fromRGB(255,100,100)
...
local repo = 'https://raw.githubusercontent.com/Cold-Script/LinoriaLib/patch-5/'

local v0 = loadstring(game:HttpGet(repo .. 'Library_Loader.lua'))()
